...
public class TinyDB {
    ...
    public ArrayList<UserDomain> getListUser(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<UserDomain> playerList =  new ArrayList<UserDomain>();

        for(String jObjString : objStrings){
            UserDomain player  = gson.fromJson(jObjString,  UserDomain.class);
            playerList.add(player);
        }
        return playerList;
    }
    ...
    public void putListUser(String key, ArrayList<UserDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(UserDomain player: playerList){
            objStrings.add(gson.toJson(player));
        }
        putListString(key, objStrings);
    }
