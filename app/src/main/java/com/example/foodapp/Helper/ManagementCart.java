...
public class ManagementCart {
    ...
    public void insertFood(FoodDomain item){
        ...
        tinyDB.putListObject(ManagementUser.user.getPhone(),foodDomains);
        Toast.makeText(context,"Added to your card",Toast.LENGTH_SHORT).show();
    }

    public ArrayList<FoodDomain> getListCart() {
        return tinyDB.getListObject(ManagementUser.user.getPhone());
    }
    public void minusNumberFood (ArrayList<FoodDomain> listfood, int position, ChangeNumberItemsListener changeNumberItensListener) {
        ...
        tinyDB.putListObject(ManagementUser.user.getPhone(), listfood);
    ...
    public int getNumInCart(){
        ArrayList<FoodDomain> foodDomains = tinyDB.getListObject(ManagementUser.user.getPhone());
